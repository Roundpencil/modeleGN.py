...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        # Fiches PNJs Line
        tk.Label(regen_window, text="Fiches PNJs").grid(row=53, column=0)
        ...
        # Evenements Line
        tk.Label(regen_window, text="Evenements").grid(row=54, column=0)
        ...
        # Objets Line
        tk.Label(regen_window, text="Objets").grid(row=55, column=0)
